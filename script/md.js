...
var line_regex = [
    ...
    [/\((.+?)\)\<(.+?)\>/gm, "_<a href='$2' target='_blank'><span class='btn'>$1</span></a>_"],
    [/\@\[(.+?)\]\((.+?)\)/gm, "<img alt='$1' src='$2'>"],
    [/e<<(.+?)>>/gm, "_<a href='mailto:$1>$1</a>_"],
    [/p<<(.+?)>>/gm, "_<a href='tel:$1>$1</a>_"],
    [/e\[(.+?)]<(.+?)>/gm, "_<a href='mailto:$2'>$1</a>_"],
    [/p\[(.+?)]<(.+?)>/gm, _"<a href='tel:$2'>$1</a>_"],
    [/<<(.+?)>>/gm, "_<a href='$1'>$1</a>_"],
