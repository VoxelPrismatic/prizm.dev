...
var IS_MAC = /(macOS|iOS|iPadOS|Mac|OS X|iPad|iPhone|iPod)/i.test(navigator.userAgent)
...
|BlackBerry|IEMobile|Opera Mini|Mobile)/i.test(window.navigator.userAgent)) {
